...
<tr>
<td><b>LOCATION</b></td>
<td><input type="text" name="loc" size="30" placeholder="Enter Location of Property">
...
<tr>
<td><b>CITY</b></td>
<td><input type="text" name="city" size="30" placeholder="Enter City Name">
...
<td><input type="text" name="desc" size="30" placeholder="About Property">
...
<tr>
<td><b>AMENITIES</b></td>
<td><input type="text" name="amen" size="30" placeholder="Facilities Provided">
...
<tr>
<td><b>AREA</b></td>
<td><input type="text" name="area" size="30" placeholder="Tell About Sorroundings">
...
<tr>
<td><b>IMAGE-1 URL</b></td>
<td><input type="file" name="img1" size="30" placeholder="Copy Link of Image">
<span class="error"><?php echo $iErr; ?></span>
  <br><br>
</td>
</tr>
<tr>
<td><b>IMAGE-2 URL:</b></td>
<td><input type="file" name="img2" size="30" placeholder="Copy Link of Image">
<span class="error"></span>
  <br><br>
</td>
</tr>
<tr>
<td><b>IMAGE-3 URL:</b></td>
<td><input type="file" name="img3" size="30" placeholder="Copy Link of Image">
<span class="error"></span>
  <br><br>
</td>
</tr>
<tr>
<td><b>IMAGE-4 URL:</b></td>
<td><input type="file" name="img4" size="30" placeholder="Copy Link of Image">
<span class="error"></span>
  <br><br>
</td>
</tr>
<tr>
<td><b>RATE</b></td>
<td><input type="text" name="rate" size="30" placeholder="Enter Amounts Per Feet"> 
