				...
				<div class="row">
					...
					<div class="col-lg-6 text-lg-right header-top-right">
						...
						<div class="user-panel">
							...
							<a href="admin.php"><i class="fa fa-user-circle-o" aria-hidden="true"></i> Admin</a>
						</div>
				</div>
			</div>
		</div>
...
<tr>
<td><b>USERNAME</b></td>
<td><input type="text" name="username" size="30" placeholder="Enter Username"required>
...
<td><input type="text" name="lno" size="30" placeholder="Enter License Number"required>
...
<tr>
<td>EMAIL ID</td>
<td><input type="text" name="email"  size="30" placeholder="Enter Email Id"required>
...
<tr>
<td>PHONE NO</td>
<td><input type="text" name="phone"  size="30" placeholder="Enter Phone Number"required>
...
<td><input type="text" name="name" size="30" placeholder="Enter Name of Organisation"required>
...
<tr>
<td><b>PASSWORD</b></td>
<td><input type="password" name="password" size="30" placeholder="Enter Password"required>
...
<td><input type="password" name="confirm" size="30" placeholder="Confirm Password"required>
