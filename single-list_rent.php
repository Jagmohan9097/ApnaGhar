			...
			<div class="row">
				<div class="col-12">
					<div class="site-navbar">
						<a href="#" class="site-logo"><img src="logo1.jpg" alt=""></a>
        ...
        <div class="col-lg-4 col-md-7 sidebar">
					...
					<div class="contact-form-card">
						...
						<form id="form" method="post">
							...
							<button name="send">Send Your Query</button>
						</form>
			...
			<div class="row">
				<div class="col-lg-3 col-md-6 footer-widget">
					...
					<div class="social">
						...
						<a href="#"><i class="fa fa-twitter"></i></a>
						<a href="#"><i class="fa fa-instagram"></i></a>
						<a href="#"><i class="fa fa-pinterest"></i></a><br>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="fa fa-heart" aria-hidden="none"></i> by <a href="https://colorlib.com" target="_blank">Colorlib </a>
