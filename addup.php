...
<tr>
<td><b>LOCATION</b></td>
<td><input type="text" name="loc" size="30" placeholder="Enter Location of Project">
...
<td><input type="text" name="date" placeholder="Months" size="30" placeholder="Enter Total Time of Project">
